...
<div class="form-group">
        <label for="inputFoodname" class="col-sm-2 control-label" style="margin-top: 5px;text-align: right;"required>料理名稱 :<!--Email--></label>
        <div class="col-sm-10">
      ...
      <div class="row" style="border:2px solid #000033;margin: 20px 60px 10px 40px;">
<div class="form-group">
      <label for="inputurl" class="col-sm-2 control-label" style="margin-top: 5px;text-align: right;">請貼上影片網址 :<!--Email--></label>
        <div class="col-sm-10">
