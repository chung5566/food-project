...
<form class="form-inline" role="form" id="food_search">
  ...
  <div class="form-group" style="margin-right:0px">
    <div class="input-group">
      ...
      <input type="text" class="form-control" id="exampleInputEmail2" placeholder="依料理名稱搜尋">
    </div>
  </div>
  <div class="form-group" style="margin-right:0px">
	...
	<div style="margin:20px" class="row">
                    ...
                    <!--<div id="myTabContent" class="tab-content"style="margin-top:30px"id="food_index_catorgory">
                        <div role="tabpanel" class="tab-pane fade row" id="breakfirst" aria-labelledby="breakfirst-tab">-->
                            ...
                            <div class="col-md-4">
                                <a href="{{ $task->article_type.$task-> id }}" class="thumbnail">
                        ...
                        <div role="tabpanel" class="tab-pane fade row" id="desert" aria-labelledby="desert-tab">
                            <div class="col-md-4">
                                <a href="#" class="thumbnail">
                                <img data-src="holder.js/100%x180" alt="100%x180" src="data:image/svg+xml;base64," data-holder-rendered="true" style="display: block;">
                                </a>
                        ...
                        <div role="tabpanel" class="tab-pane fade row" id="dinner" aria-labelledby="dinner-tab">
                            <div class="col-md-4">
                                <a href="#" class="thumbnail">
                                <img data-src="holder.js/100%x180" alt="100%x180" src="data:image/svg+xml;base64," data-holder-rendered="true" style="display: block;">
                                </a>
                   ...
                   <!--<button class="more" style="float:none; padding:5px 20px">Load more</button>-->
                    </div>     
            </div>
</div>
