  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header" style="margin-left:50px">
      <button type="button" id="navbutton" style="margin-left:20px" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
        ...
        <span class="icon-bar"></span>
        <span class="icon-bar"></span>-->
        <img src="{{URL::asset('imgs/click.png')}}">
      </button>
...
<body role=document>
    ...
    <div class='jumbotron' style="height:200px;position:relative;background-image: url({{ URL::asset('imgs/bar.jpg')}})">
        ...
        <a href="{{ url('school/create') }}" id="addSchool" class="btn" >我要開課</a>
...
<footer class="footer" role="contentinfo" style="">
    <div class="container" style="border:3px red solid ;background:red;color:white">
