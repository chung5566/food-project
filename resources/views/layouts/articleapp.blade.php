  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
                    <li><a href={{ url('/') }}>實在好家</a>
                        <li  class=active><a href=#about>實在好文</a>
...
<body role=document>
    ...
    <!--<div class='jumbotron' style="height:200px;position:relative;background-image: url({{URL::asset('logo-upload').'/'.$logo[0]->img}})">  ####這才是真的  --> 
    <div class='jumbotron' style="height:200px;position:relative;background-image: url({{URL::asset('imgs/articlebar.jpg')}})">
